...
Penny_team1 = [Vantagens_Classes_Poke.poke007,Vantagens_Classes_Poke.poke016,Vantagens_Classes_Poke.poke056]
Penny_fainted = []
Penny_team2 = []
Peny_fainted2 = []
Bag_Pok = []
...
gym_badges = []
Bag_pc = []
kripke_team = [Vantagens_Classes_Poke.poke013, Vantagens_Classes_Poke.poke014,Vantagens_Classes_Poke.poke010]
kripke_fainted = []
stuart_team = [Vantagens_Classes_Poke.poke004,Vantagens_Classes_Poke.poke037,Vantagens_Classes_Poke.poke058]
stuart_fainted = []
howard_team = [Vantagens_Classes_Poke.poke054,Vantagens_Classes_Poke.poke060,Vantagens_Classes_Poke.poke072]
howard_fainted = []
raj_team = [Vantagens_Classes_Poke.poke043,Vantagens_Classes_Poke.poke069,Vantagens_Classes_Poke.poke102]
raj_fainted = []
leonard_team = [Vantagens_Classes_Poke.poke052, Vantagens_Classes_Poke.poke084, Vantagens_Classes_Poke.poke039]
leonard_fainted = []
sheldon_team = [Vantagens_Classes_Poke.poke063,Vantagens_Classes_Poke.poke096]
sheldon_fainted = []

gym1_team = [Vantagens_Classes_Poke.poke114, Vantagens_Classes_Poke.poke111, Vantagens_Classes_Poke.poke095]
gym1_fainted = []
gym2_team = [Vantagens_Classes_Poke.poke093, Vantagens_Classes_Poke.poke083, Vantagens_Classes_Poke.poke077]
gym2_fainted = []
gym3_team = [Vantagens_Classes_Poke.poke083, Vantagens_Classes_Poke.poke067, Vantagens_Classes_Poke.poke061]
gym3_fainted = []
gym4_team = [Vantagens_Classes_Poke.poke061, Vantagens_Classes_Poke.poke070, Vantagens_Classes_Poke.poke075]
gym4_fainted = []

dad_team = [Vantagens_Classes_Poke.poke128, Vantagens_Classes_Poke.poke115 , Vantagens_Classes_Poke.poke113, Vantagens_Classes_Poke.poke108, Vantagens_Classes_Poke.poke085]
dad_fainted = []
...
3 -- Bulbassaur''')
                            ...
                            match chose_inicial:
                                case "1":
                                    ...
                                    if x.upper() == "Y":
                                        Bag_Pok.append(Vantagens_Classes_Poke.poke004)
                                ...
                                case "2":
                                    ...
                                    if x.upper() == "Y":
                                        Bag_Pok.append(Vantagens_Classes_Poke.poke007)
                                ...
                                case "3":
                                    ...
                                    if x.upper() == "Y":
                                        Bag_Pok.append(Vantagens_Classes_Poke.poke001)
                        ...
                        while trade:
                            ...
                            if change1 in Bag_Pok and change2 in Bag_pc:
                                ...
                                if confirm.upper() == "N":
                                    ...
                                    Funções.change_team(trade1, trade2)
                                    x = input("Press enter...")
